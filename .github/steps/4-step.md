...
1. 打开 **Copilot Chat** 面板，将模式切换为 **Plan Agent（规划模式）**。
   ...
   <img width="350" alt="image" src="https://github.com/CJXSIN/skills-getting-started-with-github-copilot/blob/main/.github/images/plan-mode-dropdown.png?raw=true" />
...
1. 当你对方案满意后，点击 **Start implementation** 开始真正干活。
   ...
   <img width="350" alt="image" src="https://github.com/CJXSIN/skills-getting-started-with-github-copilot/blob/main/.github/images/plan-mode-start-implementation.png?raw=true" />
